...
- Disables CredSSP on the client. This cmdlet sets the WS-Management setting \<localhost|computername\>\Client\Auth\CredSSP to false. - Removes any WSMan/ setting from the Windows CredSSP policy AllowFreshCredentials * on the client.
...
- Disables CredSSP on the client. This cmdlet sets WS-Management setting \<localhost|computername\>\Client\Auth\CredSSP to false. - Removes any WSMan/ setting from the Windows CredSSP policy AllowFreshCredentials * on the client.

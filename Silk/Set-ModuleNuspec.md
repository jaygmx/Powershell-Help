...
```
Set-ModuleNuspec [-ManifestPath] <String> [-NuspecPath] <String> [-ReleaseNotesPath] <String>
 [[-PackageID] <String>] [[-PackageTitle] <String>] [[-Tags] <String[]>] [<CommonParameters>]
```

...
```
Show-UDModal [-BackgroundColor <DashboardColor>] [-BottomSheet] [-Content <ScriptBlock>] [-FixedFooter]
 [-FontColor <DashboardColor>] [-Footer <ScriptBlock>] [-Header <ScriptBlock>] [-Height <String>] [-Persistent]
 [-Width <String>] [<CommonParameters>]
```

## DESCRIPTION
Shows a modal.
This can be called from any endpoint.

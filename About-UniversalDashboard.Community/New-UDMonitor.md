...
```
New-UDMonitor [-ArgumentList <Object[]>] [-AutoRefresh] [-BackgroundColor <DashboardColor>]
 [-BorderWidth <Int32>] [-ChartBackgroundColor <DashboardColor[]>] [-ChartBorderColor <DashboardColor[]>]
 [-DataPointHistory <Int32>] [-Endpoint <ScriptBlock>] [-FilterFields <ScriptBlock>]
 [-FontColor <DashboardColor>] [-Height <String>] [-Id <String>] [-Label <String[]>] [-Links <Hashtable[]>]
 [-Options <Hashtable>] [-RefreshInterval <Int32>] -Title <String> [-Type <ChartType>] [-Width <String>]
 [<CommonParameters>]
```

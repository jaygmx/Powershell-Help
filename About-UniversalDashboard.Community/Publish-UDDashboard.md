...
```
Publish-UDDashboard -DashboardFile <String> [-Manual] [-TargetPath <String>] [<CommonParameters>]
```
...
### -TargetPath
The target path to copy the service files to.
This will contain the dashboard and all the UD module files.

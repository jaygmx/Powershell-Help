...
```
New-UDFooter [-ArgumentList <Object[]>] [-AutoRefresh] [-BackgroundColor <DashboardColor>]
 [-Copyright <String>] [-Endpoint <ScriptBlock>] [-FontColor <DashboardColor>] [-Id <String>]
 [-Links <Hashtable[]>] [-RefreshInterval <Int32>] [<CommonParameters>]
```

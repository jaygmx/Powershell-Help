...
```
New-UDSelect [[-Id] <String>] [[-Option] <ScriptBlock>] [[-Label] <String>] [[-OnChange] <Object>]
 [-BrowserDefault] [-Icons] [-MultiSelect] [<CommonParameters>]
```
...
### -OnChange
A script block to invoke when this select changes.
The selected value is available in the script block in the $EventData variable.
...
### -Option
Options to display in this select.
This should be generated with the New-UDSelectOption cmdlet.

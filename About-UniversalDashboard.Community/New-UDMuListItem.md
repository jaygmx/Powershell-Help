...
```
New-UDMuListItem [[-Id] <String>] [[-AvatarType] <String>] [[-LabelStyle] <Hashtable>] [[-Style] <Hashtable>]
 [[-OnClick] <Object>] [[-Label] <String>] [[-Content] <ScriptBlock>] [[-RefreshInterval] <Int32>]
 [[-SubTitle] <String>] [[-Icon] <Object>] [[-Source] <String>] [[-SecondaryAction] <ScriptBlock>]
 [-AutoRefresh] [-IsButton] [-IsEndPoint] [<CommonParameters>]
```

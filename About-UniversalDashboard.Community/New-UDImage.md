...
```
New-UDImage [-Attributes <Hashtable>] [-Height <Int32>] [-Id <String>] [-Path <String>] [-Width <Int32>]
 [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_2
```
New-UDImage [-Attributes <Hashtable>] [-Height <Int32>] [-Id <String>] [-Url <String>] [-Width <Int32>]
 [<CommonParameters>]
```
...
This can be a base64 encoded data string.

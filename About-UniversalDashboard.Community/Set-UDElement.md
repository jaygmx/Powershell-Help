...
```
Set-UDElement [-Attributes <Hashtable>] [-Broadcast] [-Content <ScriptBlock>] -Id <String> [<CommonParameters>]
```
...
The attriubte hashtable is currently not merged so all attributes sent previously will be overridden.
...
### -Content
The content of the element to update.
Existing content will be replace with the content specified here.

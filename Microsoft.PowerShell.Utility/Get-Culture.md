...
You can also use the \`Get-UICulture\` cmdlet, which gets the current user interface culture on the system, and the Set-Culture (/powershell/module/international/set-culture)cmdlet in the International module.

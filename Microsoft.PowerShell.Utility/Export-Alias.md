...
- CSV. Comma-separated value (CSV) format. - Script. Creates a \`Set-Alias\` command for each exported alias. If you name the output file with a .ps1 file name extension, you can run it as a script to add the aliases to any session.

...
It is recommended that PowerShell cmdlet and function names have the \`Verb-Noun\` format and include an approved verb.
This practice makes command names more consistent, predictable, and easier to use.

Commands that use unapproved verbs, still run in PowerShell.
...
For an updated list of approved \> PowerShell verbs with descriptions, see \> Approved Verbs (../../docs-conceptual/developer/cmdlet/approved-verbs-for-windows-powershell-commands.md)in \> the Microsoft Docs.
...
These cmdlets are historic exceptions and their verbs are classified as reserved .

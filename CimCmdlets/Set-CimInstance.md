...
This example retrieves the CIM instance objects filtered by the Query parameter in to a variable \`$x\` using \`Get-CimInstance\`, and then passes the contents of the variable to the \`Set-CimInstance\` cmdlet.

...
```
Get-WmiEventConsumer [-ComputerName <String[]>] [<CommonParameters>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-WmiEventConsumer [-ComputerName <String[]>] -Name <String> [<CommonParameters>]
```
...
### -Name
Unique identifier for the event consumer to Get.

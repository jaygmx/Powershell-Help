...
For more information on how to build a provider with \`provider.manifest\` injected, see the \`.csproj\` project files on https://github.com/oneget/oneget (https://github.com/oneget/oneget).

...
Get-MgReportManagedDeviceEnrollmentFailureDetail2B3D -Filter <String> -Skip <Int32> -SkipToken <String>
 -Top <Int32> -OutFile <String> [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
### ManagedViaIdentity1
```
Get-MgReportManagedDeviceEnrollmentFailureDetail2B3D -InputObject <IReportsIdentity> -OutFile <String> [-Break]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportmanageddeviceenrollmentfailuredetail2b3d](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportmanageddeviceenrollmentfailuredetail2b3d)

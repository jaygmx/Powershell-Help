...
### Get
```
Get-MgAuditLogSignIn -SignInId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Break]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgauditlogsignin](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgauditlogsignin)

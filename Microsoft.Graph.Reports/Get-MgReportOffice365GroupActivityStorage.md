...
### Get (Default)
```
Get-MgReportOffice365GroupActivityStorage -Period <String> -OutFile <String> [-Break]
...
### GetViaIdentity
```
Get-MgReportOffice365GroupActivityStorage -InputObject <IReportsIdentity> -OutFile <String> [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```

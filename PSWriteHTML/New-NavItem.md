...
```
New-NavItem [-Name <String>] [-Href <String>] [-InternalPageID <String>] -Type <String> [-IconColor <String>]
...
```
New-NavItem [-Name <String>] [-Href <String>] [-InternalPageID <String>] -Type <String> [-IconColor <String>]
 [-IconMaterial <String>] [-Spinning] [-SpinningReverse] [-Bordered] [-BorderedCircle] [-PullLeft] [-PullRight]
 [-Rotate <String>] [-FlipVertical] [-FlipHorizontal] [<CommonParameters>]
```

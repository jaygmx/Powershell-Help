...
\`New-PSDrive\` uses the Name parameter to specify PowerShell drive named \`MyCompany\` and the PSProvider parameter to specify the PowerShell \`Registry\` provider.

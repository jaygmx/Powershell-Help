...
This parameter works only in file system drives, and will clear the content of alternative data streams on both files and directories.

You can use the \`Clear-Content\` cmdlet to change the content of amy alternate data stream, such as \`Zone.Identifier\`.
...
As of PowerShell 7.2, \`Clear-Content\` can clear the content of alternative data streams from directories as well as files.

...
A full list of Time Zone IDs can be obtained by running the following command: \`Get-TimeZone -ListAvailable\`.
...
A full list of Time Zone names can be obtained by running the following command: \`Get-TimeZone -ListAvailable\`.

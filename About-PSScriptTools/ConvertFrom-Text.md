...
In this example, the WindowsUpdate log is converted from text to objects using the regular expression pattern.
...
The first command creates a regular expression for the ARP command.

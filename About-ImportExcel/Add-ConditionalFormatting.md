...
```
Add-ConditionalFormatting [-Address] <Object> [-RuleType] <eExcelConditionalFormattingRuleType>
 [[-ConditionValue] <Object>] [[-ConditionValue2] <Object>] [-WorkSheet <ExcelWorksheet>]
 [-ForegroundColor <Object>] [-Reverse] [-BackgroundColor <Object>] [-BackgroundPattern <ExcelFillStyle>]

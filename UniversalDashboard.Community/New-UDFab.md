...
```
New-UDFab [-Id <String>] [[-Content] <ScriptBlock>] [[-ButtonColor] <DashboardColor>]
 [-IconColor <DashboardColor>] [-Icon <FontAwesomeIcons>] [-Size <Object>] [-Horizontal] [-onClick <Object>]
 [[-ExpandDirection] <String>] [<CommonParameters>]
```
...
### -IconColor The color of the icon for this fab.
...
### -onClick A script block or an endpoint created with New-UDElement to handle event clicks.

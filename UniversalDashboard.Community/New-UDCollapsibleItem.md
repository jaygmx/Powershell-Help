...
### content (Default)
```
New-UDCollapsibleItem [-Id <String>] [-Title <String>] [-Icon <FontAwesomeIcons>] [-Content <ScriptBlock>]
 [-Active] [-BackgroundColor <DashboardColor>] [-FontColor <DashboardColor>] [<CommonParameters>]
```

### endpoint
```
New-UDCollapsibleItem [-Id <String>] [-Title <String>] [-Icon <FontAwesomeIcons>] [-Endpoint <Object>]
 [-AutoRefresh] [-RefreshInterval <Int32>] [-Active] [-BackgroundColor <DashboardColor>]
...
### -Icon
The icon to display in the title of the item.
...
\`\`\`yaml Type: Int32 Parameter Sets: endpoint Aliases:

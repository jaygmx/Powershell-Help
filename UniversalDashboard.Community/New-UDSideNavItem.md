...
### Divider
```
New-UDSideNavItem [-Divider] [-Image <String>] [-Background <String>] [-Id <String>] [<CommonParameters>]
```

### SubHeader
```
New-UDSideNavItem [-SubHeader] [-Children <ScriptBlock>] [-Image <String>] [-Background <String>]
 [-Text <String>] [-Icon <FontAwesomeIcons>] [-Id <String>] [<CommonParameters>]
```

### Url
```
New-UDSideNavItem [-Url <String>] [-Image <String>] [-Background <String>] [-Text <String>]
 [-Icon <FontAwesomeIcons>] [-Id <String>] [<CommonParameters>]
```

### OnClick
```
New-UDSideNavItem [-Image <String>] [-Background <String>] [-Text <String>] [-Icon <FontAwesomeIcons>]
 [-OnClick <Object>] [-Id <String>] [<CommonParameters>]
```
...
An endpoint or script block to invoke when this item is clicked.

yaml Type: Object Parameter Sets: OnClick Aliases:

Required: False Position: Named Default value: None Accept pipeline input: False Accept wildcard characters: False

### -SubHeader

This item is a sub header.

yaml Type: SwitchParameter Parameter Sets: SubHeader Aliases:
...
yaml Type: String Parameter Sets: SubHeader, Url, OnClick Aliases:

Required: False Position: Named Default value: None Accept pipeline input: False Accept wildcard characters: False

### -Url

The URL or PageName to navigate to when clicked.

yaml Type: String Parameter Sets: Url Aliases: PageName

Required: False Position: Named Default value: None Accept pipeline input: False Accept wildcard characters: False \`\`\`

```yaml
Type: UniversalDashboard.Models.FontAwesomeIcons
Parameter Sets: SubHeader, Url, OnClick
Aliases:

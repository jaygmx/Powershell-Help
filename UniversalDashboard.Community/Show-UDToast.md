...
```
Show-UDToast -Message <String> [-MessageColor <DashboardColor>] [-MessageSize <String>] [-Duration <Int32>]
 [-Title <String>] [-TitleColor <DashboardColor>] [-TitleSize <String>] [-Id <String>]
 ...
 [-TransitionOut <String>] [-Broadcast] [<CommonParameters>]
```
...
The message to show within the toast message.
...
yaml Type: String Parameter Sets: (All) Aliases:  Accepted values: bottomRight, bottomLeft, topRight, topLeft, topCenter, bottomCenter, center

Required: False Position: Named Default value: None Accept pipeline input: False Accept wildcard characters: False

### -ReplaceToast

Whether to replace an existing toast.
...
Whether the toast should be formatted right to left.
...
yaml Type: String Parameter Sets: (All) Aliases:  Accepted values: light, dark
...
How to transition the toast into the page.

yaml Type: String Parameter Sets: (All) Aliases:  Accepted values: bounceInLeft, bounceInRight, bounceInUp, bounceInDown, fadeIn, fadeInDown, fadeInUp, fadeInLeft, fadeInRight, flipInX

Required: False Position: Named Default value: None Accept pipeline input: False Accept wildcard characters: False

### -TransitionOut

How to transition the toast out of the page.

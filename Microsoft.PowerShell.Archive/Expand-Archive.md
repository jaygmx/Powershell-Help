...
### -DestinationPath
By default, \`Expand-Archive\` creates a folder in the current location that is the same name as the ZIP file.
The parameter allows you to specify the path to a different folder.
